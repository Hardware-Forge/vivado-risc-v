...
char *spxGlobalScratchPtr;
char *spxGlobalScratchEnd;
...
ee_audiomark_initialize(void)
{
    ...
    printf("Allocs done: bmf=%p aec=%p anr=%p kws=%p\n", p_bmf_inst, p_aec_inst, p_anr_inst, p_kws_inst);
