...
//      ("I$ blocked",                        () => icache_blocked),
    ...
    new freechips.rocketchip.rocket.EventSet((mask, hits) => (mask & hits).orR, Seq(
      ...
      ("Store miss",   () => io.lsu.perf.store_miss),
      ("D$ hit",       () => io.lsu.perf.d_hit),
      ("SB hit",       () => io.lsu.perf.sb_hit),
      ("MSHR alloc",   () => io.lsu.perf.mshr_alloc),
      ("PF issued",    () => io.lsu.perf.pf_issued),
      ("PF used",      () => io.lsu.perf.pf_used)))))
