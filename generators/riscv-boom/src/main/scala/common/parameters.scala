...
// DOC include start: BOOM Parameters
  ...
  prefetchers: Seq[String] = Seq("nl"), // Changed from prefetcher (String)
  prefetchDistance: Int = 1,  // How far ahead (in strides) to start prefetching
  prefetchDegree: Int = 1,    // How many lines to prefetch per trigger
